window.APP_DATA = {
  ...
  focusStem: {
    ...
    images: [
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-01.png',
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-02.png',
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-06.png',
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-03.png',
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-04.png',
      '/xr-portfolio/img/project-screenshots/FocuSStem/focusstem-05.png',
    ],
    imageScale: '.75 .75 .75',
  },
  wellAware: {
    ...
    images: [
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-01.png',
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-02.png',
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-03.png',
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-04.png',
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-05.png',
      '/xr-portfolio/img/project-screenshots/WellAware/wellaware-06.png',
    ],
